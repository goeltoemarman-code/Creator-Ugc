        ...
        <div className="bg-neutral-50/70 border-t border-neutral-200/80 p-4 sm:p-5 space-y-4">
          ...
          {!firebaseUser ? (
            ...
            <form onSubmit={handleCommentSubmit} className="space-y-2">
              ...
              {/* Tombol Generate PDF Premium Siap Jual */}
        <div className="p-4 pt-0">
          <button
            onClick={handleExportPDF}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] rounded-xl transition-all shadow-sm"
            title="Cetak PDF Standar Jual"
          >
